  ...
  var require_privacy_options2 = __commonJS({
    "shared/js/ui/models/privacy-options.js"(exports2, module2) {
      ...
      PrivacyOptions.prototype = window.$.extend({}, Parent2.prototype, {
        ...
        async getState() {
          const settings3 = await this.sendMessage("getSetting", "all");
          ...
          this.useNoAiSearch = !!settings3.useNoAiSearch;
        }
      });
      module2.exports = PrivacyOptions;
    }
  ...
  var require_privacy_options3 = __commonJS({
    "shared/js/ui/templates/privacy-options.js"(exports2, module2) {
      ...
      module2.exports = function() {
        return bel2`<section class="options-content__privacy">
...
<li class="js-allowlist-list-item">
  ...
  var require_allowlist3 = __commonJS({
    "shared/js/ui/templates/allowlist.js"(exports2, module2) {
      ...
      var t2 = window.DDG.base.i18n.t;
      module2.exports = function() {
        return bel2`<section class="options-content__allowlist divider-bottom">
    ...
    ${addToAllowlist()}
        ...
        function addToAllowlist() {
          return bel2`<div class="allowlist-actions">
  ...
  var messageHandlers;
  var init_message_registry = __esm({
    "shared/js/background/message-registry.js"() {
      "use strict";
      messageHandlers = {};
    }
  ...
  function isExpectedSender(sender) {
    try {
      const domain = (0, import_tldts2.getDomain)(sender.url);
  ...
  var import_webextension_polyfill3, import_tldts2, MENU_ITEM_ID, REFETCH_ALIAS_ALARM, REFETCH_ALIAS_ATTEMPT, EmailAutofill, formatAddress, isValidUsername, isValidToken;
  var init_email_autofill = __esm({
    "shared/js/background/components/email-autofill.js"() {
      ...
      EmailAutofill = class {
         ...
         * }} options
         */
        constructor({ settings: settings3 }) {
          this.settings = settings3;
          this.contextMenuAvailable = !!import_webextension_polyfill3.default.contextMenus;
          ...
          import_webextension_polyfill3.default.alarms.onAlarm.addListener((alarmEvent) => {
        ...
        showContextMenuAction() {
          if (this.contextMenuAvailable) {
            import_webextension_polyfill3.default.contextMenus.update(MENU_ITEM_ID, { visible: true });
          }
        }
        hideContextMenuAction() {
          if (this.contextMenuAvailable) {
            import_webextension_polyfill3.default.contextMenus.update(MENU_ITEM_ID, { visible: false });
          }
        }
        /**
         *
