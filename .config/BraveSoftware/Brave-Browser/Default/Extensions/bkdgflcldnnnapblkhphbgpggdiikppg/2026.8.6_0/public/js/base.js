      ...
      I18n = class _I18n extends EventEmitter {
        ...
        init(options = {}, callback) {
          ...
          if (this.options.showSupportNotice !== false && !usesLocize(this)) {
            if (typeof console !== "undefined" && typeof console.info !== "undefined") console.info("\u{1F310} i18next is maintained with support from locize.com \u2014 consider powering your project with managed localization (AI, CDN, integrations): https://locize.com \u{1F499}");
          }
...
`, ErrorCode.MISSING_INTL_API, originalMessage);
  ...
  var intl_messageformat_default;
  var init_intl_messageformat = __esm({
    "node_modules/intl-messageformat/index.js"() {
      ...
      init_error2();
      init_formatters();
      intl_messageformat_default = IntlMessageFormat;
    }
  });
        ...
        _createClass(ICU2, [{
          ...
          value: function init2(i18next2, options) {
            ...
            if (i18next2) {
              ...
              i18next2.IntlMessageFormat = intl_messageformat_default;
              i18next2.ICU = this;
              if (memoize2) {
                if (bindI18n) {
  ...
  var init_options = __esm({
    "shared/locales/bg/options.json"() {
      options_default = {
        ...
        noAiMode: {
          title: "\u0411\u0435\u0437 AI \u0432 \u0442\u044A\u0440\u0441\u0435\u043D\u0435\u0442\u043E",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "\u0412\u0438\u0436\u0434\u0430\u0442\u0435 \u0440\u0435\u0437\u0443\u043B\u0442\u0430\u0442\u0438\u0442\u0435 \u043E\u0442 \u0442\u044A\u0440\u0441\u0435\u043D\u0435\u0442\u043E \u0431\u0435\u0437 \u043E\u0442\u0433\u043E\u0432\u043E\u0440\u0438 \u043E\u0442 AI (Search Assist) \u0438\u043B\u0438 AI \u0447\u0430\u0442\u043E\u0432\u0435 (Duck.ai) \u0438 \u0444\u0438\u043B\u0442\u0440\u0438\u0440\u0430\u0442\u0435 \u0433\u0435\u043D\u0435\u0440\u0438\u0440\u0430\u043D\u0438\u0442\u0435 \u043E\u0442 AI \u0438\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F \u043E\u0442 \u0440\u0435\u0437\u0443\u043B\u0442\u0430\u0442\u0438\u0442\u0435 \u0441 \u0438\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F \u043F\u043E \u043F\u043E\u0434\u0440\u0430\u0437\u0431\u0438\u0440\u0430\u043D\u0435. \u0412\u0430\u0436\u0438 \u0437\u0430 \u0432\u0441\u0438\u0447\u043A\u0438 \u0442\u044A\u0440\u0441\u0435\u043D\u0438\u044F \u043E\u0442 duckduckgo.com \u0438 \u0430\u0434\u0440\u0435\u0441\u043D\u0430\u0442\u0430 \u043B\u0435\u043D\u0442\u0430.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_options2 = __esm({
    "shared/locales/cs/options.json"() {
      options_default2 = {
        ...
        noAiMode: {
          title: "\u017D\xE1dn\xE1 AI ve vyhled\xE1v\xE1n\xED",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Zobraz\xED v\xFDsledky vyhled\xE1v\xE1n\xED bez odpov\u011Bd\xED um\u011Bl\xE9 inteligence (Search Assist) a\xA0chat\u016F s AI (Duck.ai) a ve v\xFDchoz\xEDm nastaven\xED odfiltruje obr\xE1zky vygenerovan\xE9 um\u011Blou inteligenc\xED z v\xFDsledk\u016F vyhled\xE1v\xE1n\xED. Plat\xED pro v\u0161echna vyhled\xE1v\xE1n\xED z webu duckduckgo.com a z\xA0adresn\xEDho \u0159\xE1dku.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_options3 = __esm({
    "shared/locales/da/options.json"() {
      options_default3 = {
        ...
        noAiMode: {
          title: "Ingen AI i s\xF8gning",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Se s\xF8geresultater uden AI-svar (Search Assist) eller AI-chats (Duck.ai), og filtrer AI-genererede billeder fra billedresultater som standard. G\xE6lder for alle s\xF8gninger fra duckduckgo.com og adresselinjen.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_options4 = __esm({
    "shared/locales/de/options.json"() {
      options_default4 = {
        ...
        noAiMode: {
          title: "Keine KI in der Suche",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Zeige Suchergebnisse ohne KI-Antworten (Search Assist) oder KI-Chats (Duck.ai) an und filtere standardm\xE4\xDFig KI-generierte Bilder aus den Bildergebnissen heraus. Gilt f\xFCr alle Suchanfragen von duckduckgo.com und der Adressleiste.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_options5 = __esm({
    "shared/locales/el/options.json"() {
      options_default5 = {
        ...
        noAiMode: {
          title: "\u03A7\u03C9\u03C1\u03AF\u03C2 \u03C4\u03B5\u03C7\u03BD\u03B7\u03C4\u03AE \u03BD\u03BF\u03B7\u03BC\u03BF\u03C3\u03CD\u03BD\u03B7 \u03C3\u03C4\u03B7\u03BD \u03B1\u03BD\u03B1\u03B6\u03AE\u03C4\u03B7\u03C3\u03B7",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "\u0394\u03B5\u03AF\u03C4\u03B5 \u03B1\u03C0\u03BF\u03C4\u03B5\u03BB\u03AD\u03C3\u03BC\u03B1\u03C4\u03B1 \u03B1\u03BD\u03B1\u03B6\u03AE\u03C4\u03B7\u03C3\u03B7\u03C2 \u03C7\u03C9\u03C1\u03AF\u03C2 \u03B1\u03C0\u03B1\u03BD\u03C4\u03AE\u03C3\u03B5\u03B9\u03C2 \u03C4\u03B5\u03C7\u03BD\u03B7\u03C4\u03AE\u03C2 \u03BD\u03BF\u03B7\u03BC\u03BF\u03C3\u03CD\u03BD\u03B7\u03C2 (Search Assist) \u03AE \u03C3\u03C5\u03BD\u03BF\u03BC\u03B9\u03BB\u03AF\u03B5\u03C2 \u03C4\u03B5\u03C7\u03BD\u03B7\u03C4\u03AE\u03C2 \u03BD\u03BF\u03B7\u03BC\u03BF\u03C3\u03CD\u03BD\u03B7\u03C2 (Duck.ai), \u03BA\u03B1\u03B9 \u03C6\u03B9\u03BB\u03C4\u03C1\u03AC\u03C1\u03B5\u03C4\u03B5 \u03B5\u03B9\u03BA\u03CC\u03BD\u03B5\u03C2 \u03C0\u03BF\u03C5 \u03B4\u03B7\u03BC\u03B9\u03BF\u03C5\u03C1\u03B3\u03BF\u03CD\u03BD\u03C4\u03B1\u03B9 \u03B1\u03C0\u03CC \u03C4\u03B5\u03C7\u03BD\u03B7\u03C4\u03AE \u03BD\u03BF\u03B7\u03BC\u03BF\u03C3\u03CD\u03BD\u03B7 \u03B1\u03C0\u03CC \u03C4\u03B1 \u03B1\u03C0\u03BF\u03C4\u03B5\u03BB\u03AD\u03C3\u03BC\u03B1\u03C4\u03B1 \u03B5\u03B9\u03BA\u03CC\u03BD\u03C9\u03BD \u03B2\u03AC\u03C3\u03B5\u03B9 \u03C0\u03C1\u03BF\u03B5\u03C0\u03B9\u03BB\u03BF\u03B3\u03AE\u03C2. \u0399\u03C3\u03C7\u03CD\u03B5\u03B9 \u03B3\u03B9\u03B1 \u03CC\u03BB\u03B5\u03C2 \u03C4\u03B9\u03C2 \u03B1\u03BD\u03B1\u03B6\u03B7\u03C4\u03AE\u03C3\u03B5\u03B9\u03C2 \u03B1\u03C0\u03CC \u03C4\u03BF duckduckgo.com \u03BA\u03B1\u03B9 \u03C4\u03B7 \u03B3\u03C1\u03B1\u03BC\u03BC\u03AE \u03B4\u03B9\u03B5\u03C5\u03B8\u03CD\u03BD\u03C3\u03B5\u03C9\u03BD.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
...
signal to websites your preference to:`,
        ...
        noAiMode: {
          title: "No AI in Search",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "See search results without AI answers (Search Assist) or AI chats (Duck.ai), and filter AI\u2011generated images from image results by default. Applies to all searches from duckduckgo.com and the address bar.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_options7 = __esm({
    "shared/locales/es/options.json"() {
      options_default7 = {
        ...
        noAiMode: {
          title: "Sin IA en la b\xFAsqueda",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Consulta los resultados de b\xFAsqueda sin respuestas de IA (Search Assist) ni chats de IA (Duck.ai), y filtra las im\xE1genes generadas por IA de los resultados de im\xE1genes por defecto. Se aplica a todas las b\xFAsquedas desde duckduckgo.com y la barra de direcciones.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_feedback8 = __esm({
    "shared/locales/et/feedback.json"() {
      feedback_default8 = {
        ...
        submittingFeedbackHelps: {
          title: "Anon\xFC\xFCmne tagasiside aitab meil DuckDuckGo Search & Tracker Protectioni t\xE4iustada.",
          note: "Description at top of feedback form."
        },
        reportBrokenSite: {
  ...
  var init_options8 = __esm({
    "shared/locales/et/options.json"() {
      options_default8 = {
        ...
        noAiMode: {
          title: "Otsingus ei kasutata tehisintellekti",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Kuva otsingutulemused ilma tehisintellekti vastusteta (Search Assist) v\xF5i tehisintellekti vestlusteta (Duck.ai), ja filtreeri pilditulemuste hulgast vaikimisi tehisintellekti loodud pildid. Kehtib k\xF5igi otsingute puhul, mis tehakse veebisaidil duckduckgo.com ja aadressiribalt.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_feedback9 = __esm({
    "shared/locales/fi/feedback.json"() {
      feedback_default9 = {
        ...
        submittingFeedbackHelps: {
          title: "L\xE4hett\xE4m\xE4ll\xE4 nimet\xF6nt\xE4 palautetta autat meit\xE4 parantamaan DuckDuckGo Search & Tracker Protectionia.",
          note: "Description at top of feedback form."
        },
        reportBrokenSite: {
  ...
  var init_options9 = __esm({
    "shared/locales/fi/options.json"() {
      options_default9 = {
        ...
        noAiMode: {
          title: "Ei teko\xE4ly\xE4 haussa",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "N\xE4e hakutulokset ilman teko\xE4lyn vastauksia (Search Assist) tai teko\xE4lykeskusteluja (Duck.ai) ja suodata teko\xE4lyn luomat kuvat kuvatuloksista oletusarvoisesti. Koskee kaikkia duckduckgo.com-sivustolta ja osoiterivilt\xE4 tehtyj\xE4 hakuja.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_feedback10 = __esm({
    "shared/locales/fr/feedback.json"() {
      feedback_default10 = {
        ...
        submittingFeedbackHelps: {
          title: "En r\xE9pondant \xE0 ce questionnaire anonyme, vous nous aiderez \xE0 am\xE9liorer DuckDuckGo Search & Tracker Protection.",
          note: "Description at top of feedback form."
        },
        reportBrokenSite: {
  ...
  var init_options10 = __esm({
    "shared/locales/fr/options.json"() {
      options_default10 = {
        ...
        noAiMode: {
          title: "Pas d'IA dans la recherche",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Affichez les r\xE9sultats de recherche sans r\xE9ponses IA (Search Assist) ni chat IA (Duck.ai), et filtrez par d\xE9faut les images g\xE9n\xE9r\xE9es par l'IA dans les r\xE9sultats d'images. S'applique \xE0 toutes les recherches effectu\xE9es sur duckduckgo.com et la barre d'adresse.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_options11 = __esm({
    "shared/locales/hr/options.json"() {
      options_default11 = {
        ...
        noAiMode: {
          title: "Pretra\u017Eivanje bez AI-ja",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Pogledaj rezultate pretra\u017Eivanja bez AI odgovora (Search Assist) ili AI \u010Davrljanja (Duck.ai) i filtriraj slike generirane umjetnom inteligencijom iz rezultata slika prema zadanim postavkama. Odnosi se na sva pretra\u017Eivanja s duckduckgo.com i adresne trake.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_feedback12 = __esm({
    "shared/locales/hu/feedback.json"() {
      feedback_default12 = {
        ...
        submittingFeedbackHelps: {
          title: "Az anonim visszajelz\xE9sek bek\xFCld\xE9se seg\xEDt a DuckDuckGo Search & Tracker Protection fejleszt\xE9s\xE9ben.",
          note: "Description at top of feedback form."
        },
        reportBrokenSite: {
  ...
  var init_options12 = __esm({
    "shared/locales/hu/options.json"() {
      options_default12 = {
        ...
        noAiMode: {
          title: "MI n\xE9lk\xFCli keres\xE9s",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Keres\xE9si eredm\xE9nyek megtekint\xE9se MI-v\xE1laszok (Search Assist) \xE9s MI-besz\xE9lget\xE9sek (Duck.ai) n\xE9lk\xFCl, \xE9s az MI \xE1ltal gener\xE1lt k\xE9pek alap\xE9rtelmezett kisz\u0171r\xE9se a k\xE9ptal\xE1latok k\xF6z\xFCl. Minden duckduckgo.com-r\xF3l \xE9s a c\xEDmsorb\xF3l ind\xEDtott keres\xE9sre \xE9rv\xE9nyes.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
...
segnaleremo ai siti web di:`,
        ...
        noAiMode: {
          title: "Nessuna AI nella Ricerca",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Visualizza i risultati di ricerca senza risposte AI (Search Assist) o chat AI (Duck.ai), e filtra le immagini generate dall'intelligenza artificiale dai risultati delle immagini per impostazione predefinita. Si applica a tutte le ricerche da duckduckgo.com e dalla barra degli indirizzi.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_options14 = __esm({
    "shared/locales/lt/options.json"() {
      options_default14 = {
        ...
        noAiMode: {
          title: "Paie\u0161koje n\u0117ra DI",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Matykite paie\u0161kos rezultatus be DI atsakym\u0173 (\u201ESearch Assist\u201C) ar DI pokalbi\u0173 (\u201EDuck.ai\u201C), ir pagal numatyt\u0105sias nuostatas filtruokite DI sugeneruotus vaizdus i\u0161 vaizd\u0173 paie\u0161kos rezultat\u0173. Taikoma visoms paie\u0161koms i\u0161 duckduckgo.com ir adreso juostos.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_options15 = __esm({
    "shared/locales/lv/options.json"() {
      options_default15 = {
        ...
        noAiMode: {
          title: "Mekl\u0113\u0161an\u0101 bez m\u0101ksl\u012Bg\u0101 intelekta",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Skaties mekl\u0113\u0161anas rezult\u0101tus bez m\u0101ksl\u012Bg\u0101 intelekta atbild\u0113m (Search Assist) vai m\u0101ksl\u012Bg\u0101 intelekta t\u0113rz\u0113\u0161anas sarun\u0101m (Duck.ai), un p\u0113c noklus\u0113juma filtr\u0113 att\u0113lu mekl\u0113\u0161anas rezult\u0101tos att\u0113lus, ko rad\u012Bjis m\u0101ksl\u012Bgais intelekts. Attiecas uz visiem mekl\u0113jumiem vietn\u0113 duckduckgo.com un adreses josl\u0101.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_options16 = __esm({
    "shared/locales/nb/options.json"() {
      options_default16 = {
        ...
        noAiMode: {
          title: "Ingen AI i s\xF8k",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Se s\xF8keresultater uten AI-svar (Search Assist) eller AI-chatter (Duck.ai), og filtrer AI-genererte bilder fra bilderesultater som standard. Gjelder alle s\xF8k fra duckduckgo.com og adressefeltet.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_options17 = __esm({
    "shared/locales/nl/options.json"() {
      options_default17 = {
        ...
        globalPrivacyControlDisclaimer: {
          title: "<b>Global Privacy Control (GPC) is een nieuwe standaard.\n Daarom herkennen de meeste websites deze nog niet. We werken er hard aan om ervoor te zorgen dat GCP wereldwijd wordt geaccepteerd.</b> Maar websites zijn alleen verplicht om op dit signaal te reageren voor zover de toepasselijke wetgeving dat vereist.\xA0",
          note: "Explains to the user that we can communicate their choice to the website, but the website needs to choose to support this signal"
        },
        emailProtection: {
        ...
        noAiMode: {
          title: "Geen AI in de zoekfunctie",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Bekijk zoekresultaten zonder AI-antwoorden (Search Assist) of AI-chats (Duck.ai), en filter standaard door AI gegenereerde afbeeldingen uit de zoekresultaten van afbeeldingen. Geldt voor alle zoekopdrachten vanuit duckduckgo.com en de adresbalk.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_options18 = __esm({
    "shared/locales/pl/options.json"() {
      options_default18 = {
        ...
        noAiMode: {
          title: "Brak AI w wyszukiwaniu",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Zobacz wyniki wyszukiwania bez odpowiedzi AI (Search Assist) lub czat\xF3w AI (Duck.ai) i filtruj obrazy generowane przez AI z wynik\xF3w wyszukiwania obraz\xF3w. Dotyczy wszystkich wyszukiwa\u0144 z duckduckgo.com i paska adresu.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_feedback19 = __esm({
    "shared/locales/pt/feedback.json"() {
      feedback_default19 = {
        ...
        submittingFeedbackHelps: {
          title: "O feedback an\xF3nimo ajuda-nos a melhorar os DuckDuckGo Search & Tracker Protection.",
          note: "Description at top of feedback form."
        },
        reportBrokenSite: {
  ...
  var init_options19 = __esm({
    "shared/locales/pt/options.json"() {
      options_default19 = {
        ...
        noAiMode: {
          title: "N\xE3o h\xE1 IA na pesquisa",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "V\xEA os resultados da pesquisa sem respostas de IA (Search Assist) ou chats de IA (Duck.ai) e filtra imagens geradas por IA a partir dos resultados das imagens por predefini\xE7\xE3o. Aplica-se a todas as pesquisas a partir do duckduckgo.com e da barra de endere\xE7os.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_feedback20 = __esm({
    "shared/locales/ro/feedback.json"() {
      feedback_default20 = {
        ...
        submittingFeedbackHelps: {
          title: "Trimiterea de feedback anonim ne ajut\u0103 s\u0103 \xEEmbun\u0103t\u0103\u021Bim DuckDuckGo Search & Tracker Protection.",
          note: "Description at top of feedback form."
        },
        reportBrokenSite: {
  ...
  var init_options20 = __esm({
    "shared/locales/ro/options.json"() {
      options_default20 = {
        ...
        noAiMode: {
          title: "Nu se folose\u0219te inteligen\u021Ba artificial\u0103 \xEEn c\u0103utare",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Vezi rezultatele c\u0103ut\u0103rii f\u0103r\u0103 r\u0103spunsuri AI (Search Assist) sau chat-uri AI (Duck.ai) \u0219i filtreaz\u0103 \xEEn mod implicit imaginile generate de inteligen\u021Ba artificial\u0103 din rezultatele imaginilor. Se aplic\u0103 tuturor c\u0103ut\u0103rilor de pe duckduckgo.com \u0219i din bara de adrese.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_options21 = __esm({
    "shared/locales/ru/options.json"() {
      options_default21 = {
        ...
        globalPrivacyControlDesc: {
          title: "\u041B\u0438\u0447\u043D\u044B\u0435 \u0434\u0430\u043D\u043D\u044B\u0435 \u043D\u0435 \u0434\u043E\u043B\u0436\u043D\u044B \u043F\u0440\u043E\u0434\u0430\u0432\u0430\u0442\u044C\u0441\u044F. \u041C\u044B, \u0441\u043E\u0442\u0440\u0443\u0434\u043D\u0438\u043A\u0438 DuckDuckGo, \u0441 \u044D\u0442\u0438\u043C \u043F\u043E\u043B\u043D\u043E\u0441\u0442\u044C\u044E \u0441\u043E\u0433\u043B\u0430\u0441\u043D\u044B.\n\u0410\u043A\u0442\u0438\u0432\u0438\u0440\u0443\u0439\u0442\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0443 \xAB\u0413\u043B\u043E\u0431\u0430\u043B\u044C\u043D\u044B\u0439 \u043A\u043E\u043D\u0442\u0440\u043E\u043B\u044C \u043A\u043E\u043D\u0444\u0438\u0434\u0435\u043D\u0446\u0438\u0430\u043B\u044C\u043D\u043E\u0441\u0442\u0438\xBB (Global Privacy Control \u0438\u043B\u0438 GPC), \u0438 \u043C\u044B \u043F\u0435\u0440\u0435\u0434\u0430\u0434\u0438\u043C \u0441\u0430\u0439\u0442\u0430\u043C \u0432\u0430\u0448\u0438 \u043F\u0440\u0435\u0434\u043F\u043E\u0447\u0442\u0435\u043D\u0438\u044F:",
          note: "This describes the GPC feature, which lets the user set a preference to not have their personal information sold by websites to other parties. The string is followed by a list of actions like 'Not sell your personal data'. These are translated separately."
        },
        notSellYourPersonalData: {
        ...
        noAiModeDesc: {
          title: "\u0420\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u044B \u043F\u043E\u0438\u0441\u043A\u0430 \u0432\u044B\u0434\u0430\u044E\u0442\u0441\u044F \u0431\u0435\u0437 \u043E\u0442\u0432\u0435\u0442\u043E\u0432 \u043E\u0442 \u0418\u0418 (Search Assist) \u0438 \u0418\u0418-\u0447\u0430\u0442\u043E\u0432 (Duck.ai), \u0430 \u0438\u0437 \u043A\u0430\u0440\u0442\u0438\u043D\u043E\u043A \u043F\u043E \u0443\u043C\u043E\u043B\u0447\u0430\u043D\u0438\u044E \u0438\u0441\u043A\u043B\u044E\u0447\u0430\u044E\u0442\u0441\u044F \u0438\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F, \u0441\u043E\u0437\u0434\u0430\u043D\u043D\u044B\u0435 \u0438\u0441\u043A\u0443\u0441\u0441\u0442\u0432\u0435\u043D\u043D\u044B\u043C \u0438\u043D\u0442\u0435\u043B\u043B\u0435\u043A\u0442\u043E\u043C. \u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0430 \u043F\u0440\u0438\u043C\u0435\u043D\u044F\u0435\u0442\u0441\u044F \u043A\u043E \u0432\u0441\u0435\u043C \u0437\u0430\u043F\u0440\u043E\u0441\u0430\u043C \u0441 \u0441\u0430\u0439\u0442\u0430 duckduckgo.com \u0438 \u0438\u0437 \u0430\u0434\u0440\u0435\u0441\u043D\u043E\u0439 \u0441\u0442\u0440\u043E\u043A\u0438.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_feedback22 = __esm({
    "shared/locales/sk/feedback.json"() {
      feedback_default22 = {
        ...
        submittingFeedbackHelps: {
          title: "Odosielanie anonymnej sp\xE4tnej v\xE4zby n\xE1m pom\xE1ha zlep\u0161ova\u0165 DuckDuckGo Search & Tracker Protection.",
          note: "Description at top of feedback form."
        },
        reportBrokenSite: {
  ...
  var init_options22 = __esm({
    "shared/locales/sk/options.json"() {
      options_default22 = {
        ...
        noAiMode: {
          title: "Bez umelej inteligencie vo vyh\u013Ead\xE1van\xED",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Zobrazi\u0165 v\xFDsledky vyh\u013Ead\xE1vania bez odpoved\xED s umelou inteligenciou (Search Assist) alebo chatov s umelou inteligenciou (Duck.ai), a \u0161tandardne filtrova\u0165 obr\xE1zky generovan\xE9 umelou inteligenciou z v\xFDsledkov vyh\u013Ead\xE1vania obr\xE1zkov. Vz\u0165ahuje sa to na v\u0161etky vyh\u013Ead\xE1vania z duckduckgo.com a z riadku s adresou.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_options23 = __esm({
    "shared/locales/sl/options.json"() {
      options_default23 = {
        ...
        noAiMode: {
          title: "Brez umetne inteligence v iskanju",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Oglejte si rezultate iskanja brez odgovorov umetne inteligence (Search Assist) ali klepetov umetne inteligence (Duck.ai) in privzeto filtrirajte slike, ki jih je ustvarila umetna inteligenca, iz rezultatov slik. Velja za vsa iskanja na duckduckgo.com in iz naslovne vrstice.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_feedback24 = __esm({
    "shared/locales/sv/feedback.json"() {
      feedback_default24 = {
        ...
        submittingFeedbackHelps: {
          title: "Om du skickar in anonym \xE5terkoppling hj\xE4lper du oss att f\xF6rb\xE4ttra DuckDuckGo Search & Tracker Protection.",
          note: "Description at top of feedback form."
        },
        reportBrokenSite: {
  ...
  var init_options24 = __esm({
    "shared/locales/sv/options.json"() {
      options_default24 = {
        ...
        noAiMode: {
          title: "Ingen AI i s\xF6kningen",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Se s\xF6kresultat utan AI-svar (Search Assist) eller AI-chattar (Duck.ai), och filtrera bort AI-genererade bilder fr\xE5n bildresultat som standard. G\xE4ller f\xF6r alla s\xF6kningar p\xE5 duckduckgo.com och i adressf\xE4ltet.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
  ...
  var init_feedback25 = __esm({
    "shared/locales/tr/feedback.json"() {
      feedback_default25 = {
        ...
        submittingFeedbackHelps: {
          title: "Anonim geri bildirim g\xF6ndermek, DuckDuckGo Search & Tracker Protection'\u0131 geli\u015Ftirmemize yard\u0131mc\u0131 olur.",
          note: "Description at top of feedback form."
        },
        reportBrokenSite: {
...
web sitelerine tercihinizi iletiriz:`,
        ...
        noAiMode: {
          title: "Yapay zekas\u0131z Arama",
          note: "Toggle to redirect DuckDuckGo searches to the no-AI variant (noai.duckduckgo.com)"
        },
        noAiModeDesc: {
          title: "Yapay zek\xE2 yan\u0131tlar\u0131 (Search Assist) veya yapay zek\xE2 sohbetleri (Duck.ai) olmadan arama sonu\xE7lar\u0131n\u0131 g\xF6r\xFCn ve varsay\u0131lan olarak yapay zek\xE2 taraf\u0131ndan olu\u015Fturulan g\xF6rselleri sonu\xE7lardan filtreleyin. DuckDuckGo.com'dan ve adres \xE7ubu\u011Fundan yap\u0131lan t\xFCm aramalara uygulan\u0131r.",
          note: "Description text explaining what the No AI in Searches toggle does. 'Search Assist' and 'Duck.ai' are product names and should not be translated."
        },
        burnPageTitle: {
    ...
    "shared/js/ui/base/store.js"(exports, module) {
      ...
      function deepFreeze(value) {
        ...
        Object.getOwnPropertyNames(value).forEach((property) => {
          if (Object.prototype.hasOwnProperty.call(value, property) && value[property] !== null && (typeof value[property] === "object" || typeof value[property] === "function") && !Object.isFrozen(value[property])) {
